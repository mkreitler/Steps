...
Steps = ig.Game.extend({
  ...
  background: new ig.Image( 'media/art/background.png' ),
	...
	fillLevelArray: function() {
  		this.levels[0].push(new LevelTutorial01());
  		this.levels[0].push(new LevelTutorial02());
  		this.levels[0].push(new LevelTutorial03());
  		this.levels[0].push(new LevelTutorial04());
  		this.levels[0].push(new LevelTutorial05());
  		this.levels[0].push(new LevelTutorial06());
  		this.levels[0].push(new LevelTutorial07());

  		this.levels[1].push(new LevelBasic05());
  		this.levels[1].push(new LevelBasic04());
  		this.levels[1].push(new LevelBasic03());
  		this.levels[1].push(new LevelBasic02());
  		this.levels[1].push(new LevelBasic01());
	},
