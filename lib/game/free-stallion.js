  ...
  resolveFreeMove: function(level) {
    ...
    for (var i=0; i<nTests; ++i) {
      ...
      if (this.collisionResults.bDidCollide) {
        ...
        // if (level.collideWithSceneElements(this, this.resolveRow(newY), this.resolveCol(newX)) ||
        ...
        if (level.collideWithSceneElements(this, this.resolveRow(newY + Constants.TILE_DY / 2 + dynamicLeadY), this.resolveCol(newX + Constants.TILE_DX / 2 + dynamicLeadX))) {
