	...
	spookAnimals: function(level, spookRadius) {
		if (this.isMoving()) {
			...
			if (spookedAnimal) {
				...
				if (bSpookedIsMoving && level.areOpposedDirections(this.wantDir, spookedDir)) {
					// Spooked animal is coming at us head-on.
					// TODO: force the spooked animal to resolve a collision with Duke.
				}
				else if (spookedDir !== this.wantDir) {
